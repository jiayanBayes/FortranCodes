function [results] = welfare_2step(ntotal, cbar, rho, beta, tollnew, tollold, tnew, told, scenario)
...
% scenario = 7: HOT1 and two-route uniform toll
...
cv_75 = prctile(ev4, 75);
cv_50 = prctile(ev4, 50);
cv_25 = prctile(ev4, 25); 

wstep1 = sum(ev1 .* weights);
wstep2 = sum(ev2 .* weights); 
wstep3 = sum(ev3 .* weights); 
wstep4 = sum(ev4 .* weights);
results = [wstep1; wstep2; wstep3; wstep4; cv_75; cv_50; cv_25];
